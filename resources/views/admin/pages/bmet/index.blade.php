        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap lh-1">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">BMET Registration</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
                        ...
                        @foreach($bmet_users as $key=>$data)
                            <tr>
                                <td>{{$key+1}}</td>
                                <td>{{$data->name}}</td>
                                <td>{{$data->email}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.bmet.delete',$data->id)}}" class="btn btn-danger btn-sm delete-division" data-bs-toggle="modal" data-bs-target="#deleteModal{{$data->id}}" data-category-id="{{$data->id}}">Delete</a>
                                </td>
                            </tr>
                                        ...
                                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                            <form action="{{route('admin.bmet.update', $data->id)}}" method="post" class="form">
                                                ...
                                                <div class="mb-13 text-center">
                                                    <h1 id="editModalLabel{{$data->id}}" class="mb-3">Edit BMET Registration</h1>
                                                </div>
                                                <div class="row g-9 mb-8">
                                                    <div class="col-md-12 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Name</label>
                                                        <input type="text" name="name" class="form-control form-control-solid"  value="{{$data->name}}" placeholder="Enter Name"/>
                                                    </div>
                                                    <div class="col-md-12 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Email</label>
                                                        <input type="email" name="email" class="form-control form-control-solid" value="{{$data->email}}" placeholder="Enter Email"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-9 mb-8">
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <input type="text" name="phone" class="form-control form-control-solid"  value="{{$data->phone}}" placeholder="Enter Phone"/>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete this BMET?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                            <a href="{{ route('admin.bmet.delete', $data->id) }}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modalFormDataSave" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form action="{{route('admin.bmet.store')}}" method="post" class="form">
                        @csrf
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Add BMET Registration</h1>
                        </div>
                        <div class="row g-9 mb-8">
                            <div class="col-md-12 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Name</label>
