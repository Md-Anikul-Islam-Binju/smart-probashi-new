                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Hospital" />
                        </div>
                        ...
                        @foreach($hospitals as $key=>$data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.hospital.delete',$data->id)}}" class="btn btn-danger btn-sm delete-division" data-bs-toggle="modal" data-bs-target="#deleteModal{{$data->id}}" data-category-id="{{$data->id}}">Delete</a>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content rounded">
                                        ...
                                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                            <form action="{{route('admin.hospital.update', $data->id)}}" method="post" class="form">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="row g-9 mb-8">
                                                    <div class="col-md-12 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Hospital Name</label>
                                                        <input type="text" name="name" class="form-control form-control-solid"  value="{{$data->name}}" placeholder="Enter Hospital Name"/>
                                                    </div>
                                                    <div class="col-md-12 fv-row">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel{{$data->id}}">Delete Hospital</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('admin.hospital.delete', $data->id) }}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modalFormDataSave" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form action="{{route('admin.hospital.store')}}" method="post" class="form">
                        @csrf
                        <div class="mb-13 text-center">
