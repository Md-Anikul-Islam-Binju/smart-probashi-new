                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
                        ...
                        @foreach($divisions as $key=>$data)
                            ...
                            <td>
                                ...
                                <a href="{{route('admin.division.delete',$data->id)}}" class="btn btn-danger btn-sm delete-division" data-bs-toggle="modal" data-bs-target="#deleteModal{{$data->id}}" data-category-id="{{$data->id}}">Delete</a>
                            </td>
                        </tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content rounded">
                                        ...
                                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                            <form action="{{route('admin.division.update', $data->id)}}" method="post" class="form">
                                                @csrf
                                                @method('PUT')
                                                <div class="mb-13 text-center">
                                                    <h1 id="editModalLabel{{$data->id}}" class="mb-3">Edit Division</h1>
                                                </div>
                                                <div class="row g-9 mb-8">
                                                    <div class="col-md-12 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Division Name En</label>
                                                        <input type="text" name="division_name_en" class="form-control form-control-solid"  value="{{$data->division_name_en}}" placeholder="Enter Title English"/>
                                                    </div>
                                                    <div class="col-md-12 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Division Name Bn</label>
                                                        <input type="text" name="division_name_bn" class="form-control form-control-solid" value="{{$data->division_name_bn}}" placeholder="Enter Title Bangla"/>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('admin.division.delete', $data->id) }}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modalFormDataSave" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form action="{{route('admin.division.store')}}" method="post" class="form">
                        @csrf
                        <div class="mb-13 text-center">
                        ...
                        <div class="row g-9 mb-8">
                            <div class="col-md-12 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Division Name En</label>
                                <input type="text" name="division_name_en" class="form-control form-control-solid" placeholder="Enter Title English"/>
                            ...
                            <div class="col-md-12 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Division Name Bn</label>
                                <input type="text" name="division_name_bn" class="form-control form-control-solid" placeholder="Enter Title Bangla"/>
