        ...
        <div id="kt_toolbar_container" class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-4 text-center">
                    <h1 class="text-dark fw-bold my-1 fs-3">Admin Approved Ongoing Application</h1>
                </div>
                <div class="col-4"></div>
            </div>
        </div>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-hover training_table dataTable no-footer dtr-inline" id="kt_datatable">
                                        ...
                                        <tr>
                                            ...
                                            <th width="150" class="text-center">Applied Candidates</th>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group dropstart action_button_wrapper">
                                                        ...
                                                        <ul class="dropdown-menu action_dropdown_menu">
                                                            <li>
                                                                <a class="dropdown-item" href="{{route('admin.clearance.sign',$clearanceData->id)}}"><i class="fa-solid fa-eye"></i> Approved By </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
