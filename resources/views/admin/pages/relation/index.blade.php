        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap lh-1">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Relation</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        @foreach($relations as $key=>$data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.relation.delete',$data->id)}}" class="btn btn-danger btn-sm delete-division" data-bs-toggle="modal" data-bs-target="#deleteModal{{$data->id}}" data-category-id="{{$data->id}}">Delete</a>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content rounded">
                                        ...
                                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                            <form action="{{route('admin.relation.update', $data->id)}}" method="post" class="form">
                                                @csrf
                                                @method('PUT')
                                                <div class="mb-13 text-center">
                                                    <h1 id="editModalLabel{{$data->id}}" class="mb-3">Edit Relation</h1>
                                                </div>
                                                <div class="row g-9 mb-8">
                                                    <div class="col-md-12 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Relation Name</label>
                                                        <input type="text" name="relation_name" class="form-control form-control-solid"  value="{{$data->relation_name}}" placeholder="Enter Title English"/>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel{{$data->id}}">Delete Relation</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('admin.relation.delete', $data->id) }}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modalFormDataSave" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form action="{{route('admin.relation.store')}}" method="post" class="form">
                        @csrf
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Add Relation</h1>
                        </div>
                        <div class="row g-9 mb-8">
                            <div class="col-md-12 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2 required">Relation Name</label>
                                <input type="text" name="relation_name" class="form-control form-control-solid" placeholder="Enter Relation Name"/>
                            </div>
                        </div>
