                    ...
                    <div class="fmenu_section">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <form id="payment-form" action="{{route('recruiting-agency.registration.payment.store')}}" method="post" class="d-none">
                                    @csrf
                                    <input type="hidden" id="input_agree" name="status" value="1">
                                    <input type="hidden" name="payable_amount" value="300">
                                    <input type="hidden" name="passport_info_id" value="{{$passportId}}">
                                    <input type="hidden" id="input_channel" name="payment_method" value="bkash">
                                </form>
                            </div>
                        </div>
                    </div>
