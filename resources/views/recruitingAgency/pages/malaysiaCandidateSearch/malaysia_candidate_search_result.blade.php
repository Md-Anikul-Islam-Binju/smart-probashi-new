                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-hover training_table dataTable no-footer dtr-inline" style="margin: 13px 0px !important;" id="kt_datatable" role="grid" aria-describedby="posts_info">
                                        <thead>
                                        <tr role="row">
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 135px;">Name</th>
                                            <th class="sorting_disabled text-center" rowspan="1" colspan="1" style="width: 225px;">Phone</th>
                                        ...
                                        <tbody>
                                        @foreach($allRegisterUser as $key=>$allRegisterUserData)
                                            <tr role="row">
                                                <td tabindex="0" data-kt-ecommerce-product-filter="job_category_name">
                                                    <a href="{{route('recruiting-agency.bmet.registration.details',$allRegisterUserData->id)}}">
                                                        {{$allRegisterUserData->full_name}}
                                                    </a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{route('recruiting-agency.bmet.registration.details',$allRegisterUserData->id)}}">
                                                        {{$allRegisterUserData->phone}}
                                                    </a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{route('recruiting-agency.bmet.registration.details',$allRegisterUserData->id)}}">
                                                        @php
                                                            $dob = \Carbon\Carbon::parse($allRegisterUserData->dob);
                                                ...
                                                <td class="text-left">
                                                    <a href="{{route('recruiting-agency.bmet.registration.details',$allRegisterUserData->id)}}">
                                                        {{$allRegisterUserData->passport_no}}
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group dropstart action_button_wrapper">
                                                        ...
                                                        <ul class="dropdown-menu action_dropdown_menu">
                                                            <li>
                                                                <a class="dropdown-item" href="{{route('recruiting-agency.bmet.registration.details',$allRegisterUserData->id)}}"><i class="fa-solid fa-eye"></i> View </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" data-bs-toggle="modal" href="#assign_job_modal" role="button" onclick="setPassportId({{ $allRegisterUserData->id }})">Attached to a Job</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
