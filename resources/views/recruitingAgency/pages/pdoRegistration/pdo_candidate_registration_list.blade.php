        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap lh-1">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">PDO Candidate Register List</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        <a href="{{route('recruiting-agency.pdo.registration')}}" class="btn btn-primary">New PDO Registration</a>
                    </div>
                </div>
                        ...
                        @foreach($pdo_candidates as $key=>$data)
                            <tr>
                                ...
                                <td class="mt-2">
                                    ...
                                    @else
                                        @if($data->step_no==1)
                                            <a href="{{ route('recruiting-agency.pdo.registration', ['id' => $data->id,'type' => 'batch-info']) }}" class="btn btn-primary" title="move to pdo">
                                                Complete Registration
                                            </a>
                                        @elseif($data->step_no==2)
                                            <a href="{{ route('recruiting-agency.pdo.registration', ['id' => $data->id,'type' => 'payment-info']) }}" class="btn btn-primary" title="move to pdo">
                                                Complete Registration
                                            </a>
                                        @elseif($data->step_no==3)
                                            <a href="{{ route('recruiting-agency.pdo.registration', ['id' => $data->id,'type' => 'upload-photo']) }}" class="btn btn-primary" title="move to pdo">
                                                Complete Registration
                                            </a>
                                        @endif
                                    @endif
