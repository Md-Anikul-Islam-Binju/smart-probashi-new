                    ...
                    <div class="fmenu_section">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <form id="payment-form" action="{{route('recruiting-agency.pdo.registration.payment.store')}}" method="post" class="d-none">
                                    @csrf
                                    <input type="hidden" id="input_agree" name="payment_status" value="1">
                                    <input type="hidden" name="fees" value="300">
                                    <input type="hidden" id="input_channel" name="payment_through" value="bkash">
                                    <input type="hidden" name="pdoId" value="{{$pdoId}}">
                                </form>
                            </div>
                        </div>
                    </div>
