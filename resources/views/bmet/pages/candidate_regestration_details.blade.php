            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex mt-5 justify-content-center">
                        @if($passportDetailsInfos->verificationInfo->candidate_verify_status == 1)
                            <a href="{{route('bmet.registered.not.approved',$passportDetailsInfos->id)}}" class="btn btn-danger me-2 px-6">Reject</a>
                        @else
                            <a href="{{route('bmet.registered.approved',$passportDetailsInfos->id)}}" class="btn btn-primary me-2 px-6">Approve</a>
                        @endif
                    </div>
                </div>
            </div>
